...
class LocalGameMenu:
    def __init__(self, SCREEN_HEIGHT, SCREEN_WIDTH ):
        ...
        self.pa = ["Hráč", "AI random", "AI playrandom", "AI greedy", "AI rule", "AI mcts short", "AI mcts long"]
        self.pan = ["Hráč", "AI random", "AI playrandom", "AI greedy", "AI rule", "AI mcts short", "AI mcts long", "Žádný"]
        self.p2id = 0
        self.p3id = 0   
        self.p4id = 0
        self.p5id = 0

...
class Menu():
    def __init__(self, SCREEN_HEIGHT, SCREEN_WIDTH):
        ...
        self.local_button = button.Button(b_x, b_y, b_width, b_height, "Lokální hra", pygame.font.SysFont(None, 36), (70, 130, 180), (100, 160, 210))  
        self.buttons.append(self.local_button)
        b_y = b_y + b_height + b_interval
        self.quit_button = button.Button(b_x, b_y, b_width, b_height, "Ukončit", pygame.font.SysFont(None, 36), (70, 130, 180), (100, 160, 210))
